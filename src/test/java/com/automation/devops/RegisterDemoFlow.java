...
/*		//Validate the current URL
	...
	public void navigateRegistrationForm() {
		...
		WebElement demoSites = driver.findElement(By.xpath("(//a[contains(text(),'Demo Sites')])[2]"));
		...
		WebElement registrationForm = driver.findElement(By.xpath("(//a[normalize-space()='Registration Form'])[2]"));
	...
	public void registerUser() {
		...
		WebElement formTitle = driver.findElement(By.xpath("//h3[normalize-space()='Register For Demo']"));
	...
	public void validateTransactionDetails() {
		...
		//Step 5. Validate the successful message
		...
		System.out.println("Successful Transaction message is validated");
	}
	
	@Test(priority = 5)
	public void closeApplication() {
		driver.quit();
		System.out.println("Application is close successfully");
	}
